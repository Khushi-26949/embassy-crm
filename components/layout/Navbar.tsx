    ...
    <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center gap-3 border-b border-coolgrey dark:border-night-border bg-white/80 px-4 backdrop-blur-md transition-colors duration-300 dark:border-night-border dark:bg-night-card/90 md:gap-4 md:px-6">
      ...
      <div className="ml-auto flex items-center gap-2 md:ml-0 md:gap-3">
        ...
        <button
          ...
          className="relative rounded-full p-2 text-ink/70 transition-colors duration-150 hover:bg-ivory dark:bg-night hover:text-crimson dark:text-ivory/70 dark:hover:bg-night-surface"
        >
          ...
          {userMenuOpen ? (
            ...
            >
              ...
              <button
                type="button"
                role="menuitem"
                className="w-full px-4 py-2 text-left text-sm text-crimson hover:bg-ivory dark:bg-night dark:hover:bg-night-surface"
              >
                Sign out
              </button>
            </div>
