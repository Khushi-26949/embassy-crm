...
export function KanbanColumn({
  ...
  return (
    <div
      className={cn(
        'flex min-w-[280px] shrink-0 snap-start scroll-ml-4 flex-col rounded-xl border border-coolgrey dark:border-night-border bg-white dark:bg-night-card md:min-w-[280px] lg:min-w-0 lg:flex-1',
    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-2">
          ...
          <span className="rounded-full bg-white/80 px-2 py-0.5 text-xs font-semibold text-ink dark:text-ivory dark:bg-night-surface">
            {leads.length}
          </span>
        </div>
      ...
      <div
        ref={setNodeRef}
        className="flex min-h-[500px] flex-1 flex-col bg-ivory dark:bg-night p-3"
      >
      ...
      <div className="border-t border-coolgrey dark:border-night-border bg-ivory dark:bg-night px-3 py-3">
        <Button
          type="button"
          variant="ghost"
          size="sm"
