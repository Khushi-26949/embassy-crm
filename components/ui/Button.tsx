...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    'border border-gold text-ink dark:text-ivory hover:bg-gold/10 focus-visible:ring-gold',
  ghost:
    'text-ink dark:text-ivory hover:bg-ink/5 focus-visible:ring-ink/20 dark:hover:bg-night-surface',
  danger:
