...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center justify-center rounded-xl border border-dashed border-coolgrey dark:border-night-border bg-white dark:bg-night-card px-6 py-10 text-center',
        className
      )}
    >
